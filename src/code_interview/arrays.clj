...
(defn char-edit?
  [x y prev-edit]
  (and (not= x y) (empty? prev-edit)))


(defn ins-edit?
  [x y [prev-x _]]
  (and (not= x y) (= y prev-x)))


(defn rem-edit?
  [x y [_ prev-y]]
  (and (not= x y) (= x prev-y)))


(defn rep-edit?
  [x y prev-edit]
  (and (= x y) (not-empty prev-edit)))
